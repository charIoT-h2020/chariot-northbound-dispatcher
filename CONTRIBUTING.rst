...
The best way to send feedback is to file an issue at https://github.com/theofilis/chariot_northbound_dispatcher/issues.
...
1. Fork the `chariot_northbound_dispatcher` repo on GitHub.
2. Clone your fork locally::

    $ git clone git@github.com:your_name_here/chariot_northbound_dispatcher.git
...
3. The pull request should work for Python 2.7, 3.4, 3.5 and 3.6, and for PyPy. Check
   https://travis-ci.org/theofilis/chariot_northbound_dispatcher/pull_requests
